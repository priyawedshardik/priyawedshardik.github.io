/**
 * @author Hardik <hvj.joshi06@gmail.com>
 */
(function ($) {
    "use strict";
...
var countDownDate = new Date("April 21, 2024 20:45:00").getTime();
...
console.log('\n\n%c SAVE THE DATE: 21st Aptil, 2024!', styles);

console.log('%cYour presence is requested!%c\n\nRegards: Mamta Vivek Joshi', styles1, styles2);
